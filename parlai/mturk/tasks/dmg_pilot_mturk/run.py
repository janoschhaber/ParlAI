...
def main():
    ...
    qual_name = 'DMG_Pilot_:_Max_Games_Reached_TEMP2'
    qual_desc = ('Qualification for a worker who completed 10 games in the DMG Pilot. Used to filter to different task pools.')
    ...
    try:
        ...
        def update_records(players, id):
            ...
            for player in players:
                ...
                if len(worker_record[player_id]) == 10:
        ...
        def run_conversation(mturk_manager, opt, workers):
            ...
            for agent in agents:
                if len(worker_record[agents[0].worker_id]) > 1:
                    agent.pay_bonus(0.25, reason="Multiple games")
